"""Main interface for the velbusaio lib with a faster scan."""
...
from velbusaio.handlerfast import PacketHandlerFast
...
class VelbusFast:
    ...
    def __init__(
        ...
        self._handler = PacketHandlerFast(self, one_address)
